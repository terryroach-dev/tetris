document.addEventListener("DOMContentLoaded", () => {
  ...
  //   randomly select a tetromino and it's first tetromino
  ...
  // Move the tetromino to the left, unless at the edge or there is a blockage
  function moveLeft() {
    undraw();
  ...
  // Move he tetromino to the right, unless at the edge or there is a blockage
  function moveRight() {
    undraw();
  ...
  function rotate() {
    undraw();
    currentRotation++;
    // If current rotation get to 4 push it back to 0
